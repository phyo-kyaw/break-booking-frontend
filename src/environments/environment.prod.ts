...
export const environment = {
 // production: false,
  ...
  roomsApi: '${HOME_URL}/api/v1/app/rooms',
  dictApi: '${HOME_URL}/api/v1/dicts', // dictionaries
  roomBooking: '${HOME_URL}/api/v1/app/bookings', // room booking controller
  roomPayment: '${HOME_URL}/api/v1/payment',
